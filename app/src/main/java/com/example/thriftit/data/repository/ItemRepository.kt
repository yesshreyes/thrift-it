...
class ItemRepository @Inject constructor(
    ...
    fun getAllItems(): Flow<Result<List<Item>>> = callbackFlow {
    ...
    fun searchItems(query: String): Flow<Result<List<Item>>> = callbackFlow {
        trySend(Result.Loading)
    ...
    fun getItemsByCategory(category: ItemCategory): Flow<Result<List<Item>>> = callbackFlow {
        trySend(Result.Loading)
    ...
    // Get items by seller
    fun getItemsBySeller(sellerId: String): Flow<Result<List<Item>>> = callbackFlow {
        trySend(Result.Loading)
    ...
    suspend fun updateItemAvailability(itemId: String, isAvailable: Boolean): Result<Unit> {
        return try {
